...
/// 상점 UI 프리젠터 클래스
/// </summary>
public class ShopPresenter : IPresenter, ITooltipProvider
{
    #region 레퍼런스
    ...
    private void HandleProductPointerEntered(IProduct product)
    {
        ...
        //이벤트 호출
        OnTooltipRequested?.Invoke(context);
    }
    ...
    {
        //이벤트 호출
        OnTooltipRequestCanceled?.Invoke(product);
    }
    #endregion
