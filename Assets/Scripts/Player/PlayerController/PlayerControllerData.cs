...
/// </summary>
[CreateAssetMenu(fileName = "PlayerControllerData", menuName = "SO/PlayerControllerData", order = 0)]
public class PlayerControllerData : ScriptableObject
{
    ...
    [Header("Jump")]
    [SerializeField] private float _maxJumpHeight = 0.5f;
    [SerializeField] private float _maxJumpDuration = 0.5f;
